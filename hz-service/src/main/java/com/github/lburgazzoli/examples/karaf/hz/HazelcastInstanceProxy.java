 ...
 *
 */
public class HazelcastInstanceProxy implements HazelcastInstance {
    private static final Logger LOGGER = LoggerFactory.getLogger(HazelcastInstanceProxy.class);
     ...
     */
    public HazelcastInstanceProxy(final HazelcastInstance instance) {
        m_instance = instance;
    }
     ...
     */
    public HazelcastInstanceProxy(final Config config) {
